...
| :--- | :--- | :--- | :--- |
| **Universal (پیشنهادی)** | تمامی مدل‌ها و پردازنده‌ها (All Archs) | ۲۷.۳ مگابایت | [📥 دانلود مستقیم نسخه Universal](https://github.com/sinamp00/sina/releases/download/v2.5.0/SinaVPN-Universal-Release.apk) |
| **arm64-v8a (فوق سبک)** | گوشی‌های جدید ۶۴ بیتی (Snapdragon, Tensor...) | ۱۱.۰ مگابایت | [📥 دانلود مستقیم نسخه arm64](https://github.com/sinamp00/sina/releases/download/v2.5.0/SinaVPN-arm64-Release.apk) |
...
## ✨ ویژگی‌های کلیدی نسخه ۲.۵

### ۱. چهار موتور اتصال ضد فیلتر
- **✨ پروتکل سینا (Sina-Stealth)**: تکه‌تکه‌سازی هوشمند بسته‌ها (`AETHER_MASQUE_H2_FRAGMENT=1`) و تغییر سایز پکت‌ها برای دور زدن کامل فایروال‌های ملی.
- **⚡ وارپ پلاس (WARP+)**: اتصال به شبکه رله‌های اختصاصی کلودفلر با پینگ فوق‌العاده پایین برای گیمینگ و استریم.
- **🛡️ وایرگارد پرو (WireGuard Pro)**: تانل پایدار بدون نشتی DNS با بالاترین نرخ انتقال داده و مصرف کم باتری.
- **🌐 تانل ماسک (MASQUE HTTP/2)**: نسل بعدی تانلینگ امن بر بستر پورت‌های وب استاندارد.

### ۲. پالت رنگی ۹ گانه نئونی و رابط کاربری Liquid Glass
...
```text
3978fde3f0bee4af3e9fb26254c18c827c89e2e1359344f4de5954219634abd8  SinaVPN-arm64-Release.apk
fabb3527f8d5f63849ce8c3c6c8d005a91c86764a0f93942aa0e82fa7bf10c7c  SinaVPN-Universal-Release.apk
```
